...
export default function LoginPage() {
  ...
  if (user) { navigate('/servers'); return null }

  return (
    <div className="login-page">
      <div className="login-card">
        <div className="login-logo">Ten<span className="accent">ancy</span></div>
        <p className="login-subtitle">Panel de administración para tu servidor de Discord</p>
        ...
        <p style={{ marginTop: 20, fontSize: '0.75rem', color: 'var(--text-muted)' }}>
          Necesitas permisos de administrador en el servidor para acceder.
        </p>
      </div>
    </div>
  )
